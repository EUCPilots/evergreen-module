function Get-EvergreenLibraryItem {
    <#
    ...
    param (
        ...
        [System.Management.Automation.PSObject] $Library,
    ...
    process {
        # Validate $Library has the required properties
        if ([System.Boolean]($Library.Inventory)) {
